...
class NormalProduct extends Component {
  ...
  getImgList(imgList) { //获取图片列表，imgList就是在handleSubmit(e){}里获取到的
    this.setState({
      imgList:imgList
    })
  }
  ...
  handleSubmit(e) {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        values.images = this.state.imgList; /*因为图片列表也是显示在form表单里，
//     所以imgs是values上的一个属性，将获取到的imgs赋予imgList*/
        console.log("values", values);
